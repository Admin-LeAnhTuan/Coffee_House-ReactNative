...
const EditDrinkScreen = ({navigation}: any) => {
            ...
            <View style={styles.scrollContent}>
                ...
                <View style={styles.inputContainer}>
                    ...
                    <View style={{ position: 'relative' }}>
                        <TouchableOpacity style={{ position: 'absolute', right: 20, top: 15, zIndex: 999 }}>
                            <Feather name="x-circle" size={24} color="#fff" />
                        </TouchableOpacity>
                        <Text style={styles.inputText}>S</Text>
                    </View>
                    <View style={{ position: 'relative' }}>
                        <TouchableOpacity style={{ position: 'absolute', right: 145, top: 9, zIndex: 999 }}>
                            <MaterialIcons name="add-circle" size={35} color="#fff" />
                        </TouchableOpacity>
